...
{
    public partial class TertiaryJobListner : ServiceBase
    {
        public TertiaryJobListner()
        {
            InitializeComponent();
        }

        internal static string AUDITORSOURCE = "Tertiary Print Job Listner";
        internal static string SERVICE_NAME = "AccountingPlusTertiaryJobListner";
        ...
        {
            JobListner.JobProcessor.RecordServiceTimings("AccountingPlusTertiaryJobListner", listenerPort, "start");
        ...
        {
            JobListner.JobProcessor.RecordServiceTimings("AccountingPlusTertiaryJobListner", listenerPort, "stop");
        }
