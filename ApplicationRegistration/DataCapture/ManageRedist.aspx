<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster/Header.Master" AutoEventWireup="true" CodeBehind="ManageRedist.aspx.cs" Inherits="ApplicationRegistration.DataCapture.ManageRedist" %>
            ...
            <table cellpadding="2" cellspacing="3" border="0" align="center" id="UserForm" runat="server">
                <tr>
                    <td>
                        <fieldset>
                            <legend>
                                <asp:Label ID="LabelFieldSetTitle" runat="server" Text="Redistributor Information" Font-Bold="True"></asp:Label></legend>
                            <asp:Table ID="TableManageRedist" runat="server" Width="100%" CellPadding="1" CellSpacing="1">
                                <asp:TableRow>
                                ...
                                <asp:TableRow>
                                    <asp:TableCell Wrap="false">
                                        <asp:Label ID="LabelRedistId" runat="server" Text="Redistributor ID"></asp:Label>&nbsp;*</asp:TableCell>
                                    <asp:TableCell>
                                        <asp:TextBox ID="TextBoxRedistId" runat="server" Width="328px" MaxLength="30" CssClass="DataCapture"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="requiredFieldLabelUserID" runat="server" ControlToValidate="TextBoxRedistId"
                                            ...
                                            Display="None"></asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="RegularExpressionValidator1"
                                                runat="server" ControlToValidate="TextBoxRedistId" Display="None" ErrorMessage="Please enter alphanumeric value"
