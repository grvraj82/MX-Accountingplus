...
/* Copyright 2010 (c), SHARP CORPORATION.
  ...
  Author(s): Prasad
  File Name: ApplicationErrorMessage.aspx
  Description: Print release application Error Message Display
...
namespace AccountingPlusWeb
{
    ...
    ///     </listheader>
    ///     <item>
    ///        <term>ApplicationErrorMessage</term>
    ///            <description>Error Message Display</description>
    ///     </item>
    /// </summary>
    /// <remarks>
    /// Class Diagram:<br/>
    /// <img src="ClassDiagrams/CD_PrintRoverWeb.ApplicationErrorMessage.png" />
    /// </remarks>
    
    public partial class ApplicationErrorMessage :ApplicationBase.ApplicationBasePage
    {
        /// <summary>
        ...
        /// <remarks>
        /// Sequence Diagram:<br/>
        /// <img src="SequenceDiagram/SD_PrintRoverWeb.ApplicationErrorMessage.Page_Load.png" />
        /// </remarks>
        protected void Page_Load(object sender, EventArgs e)
        {
            
            LocalizeThisPage();
            if (Application["ApplicationError"] != null)
            {
                try
                {
                    LiteralApplicationName.Text = Constants.APPLICATION_TITLE;
                    string machineName = Environment.MachineName.ToString();
                    string RemoteHost = Request.Params["REMOTE_ADDR"].ToString();
                    Exception exception = (Exception)Application["ApplicationError"];
                    LabelErrorMessage.Text = exception.Message;
                    LabelErrorSource.Text = exception.Source;
                ...
                ////    messageBody += "<tr><td colspan=2 bgcolor=red align=center><font color='white' face=verdana size=3><b><marquee scrollamount=50 scrolldelay=500 behavior=alternate>Application Error on " + Constants.APPLICATION_TITLE + " [WEB] Server</marquee></b></font></td></tr>";
        ...
        /// <remarks>
        /// Sequence Diagram:<br/>
        /// <img src="SequenceDiagram/SD_PrintRoverWeb.ApplicationErrorMessage.LocalizeThisPage.png" />
        /// </remarks>
        private void LocalizeThisPage()
        {
            string labelResourceIDs = "ERROR_MESSAGE,PRINT_RELEASE_APPLICATION_ERROR_DETAILS,ERROR_SOURCE,TRACE,ACTION,SUGGESTION,PLEASE_CONTACT_ADMINISTRATOR";
