<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/InnerPage.Master" AutoEventWireup="true"
    CodeBehind="ManageUserCards.aspx.cs" Inherits="AccountingPlusWeb.Administration.ManageUserCards" %>
                    ...
                    <tr class="Top_menu_bg">
                        <td class="HeadingMiddleBg" style="width: 10%">
                            <div style="padding: 4px 10px 0px 10px;">
                                <asp:Label ID="LabelUserManagement" runat="server" Text=""></asp:Label></div>
                        </td>
                        <td>
                        ...
                        <td width="1%" align="left" valign="middle">
                            &nbsp;
                            <asp:ImageButton ID="ImageButtonExportToCsv" ToolTip="Click here to download users"
                        ...
                        <td>
                            <asp:Table EnableViewState="false" ID="TableUsers" CellSpacing="1" CellPadding="4"
                                ...
                                <asp:TableHeaderRow CssClass="Table_HeaderBG">
                                    ...
                                    <asp:TableHeaderCell Wrap="false" ID="TableHeaderCellUserSource" Text=""
                                        CssClass="H_title"></asp:TableHeaderCell>
                                          <asp:TableHeaderCell Wrap="false" ID="TableHeaderCellUserDomain" Text=""
                                        CssClass="H_title"></asp:TableHeaderCell>
                                    <asp:TableHeaderCell Wrap="false" ID="TableHeaderCellCardID" Text="" HorizontalAlign="Left"
                                        CssClass="H_title"></asp:TableHeaderCell>
                                    <asp:TableHeaderCell Wrap="false" ID="TableHeaderCellPinId" Text="" HorizontalAlign="Left"
                                        CssClass="H_title"></asp:TableHeaderCell>
                                </asp:TableHeaderRow>
                            </asp:Table>
                        </td>
