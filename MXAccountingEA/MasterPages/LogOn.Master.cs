...
namespace AccountingPlusEA.MasterPages
{
    /// <summary>
    /// MFP Master Page
    /// <list type="table">
    ...
    /// <remarks>
    /// Class Diagram:<br/>
    /// <img src="ClassDiagrams/CD_PrintReleaseEA.MasterPages.LogOn.png" />
    /// </remarks>
    /// <remarks>
    public partial class LogOn : System.Web.UI.MasterPage
    {
        ...
        /// <remarks>
        /// Sequence Diagram:<br/>
        /// 	<img src="SequenceDiagrams/SD_PrintReleaseEA.MasterPages.LogOn.Page_Load.jpg"/>
        /// </remarks>
        ...
        private void ApplyThemes()
        {
            ...
            if (File.Exists(backgroundImageAbsPath))
            {
                ...
                if (currentRequestPage.ToLower().IndexOf("cardlogin.aspx") > -1)
                {
                    backgroundImage = string.Format("../App_UserData/WallPapers/{0}/{1}/Card_CustomAppBG.jpg", currentTheme, deviceModel);
                }
            }
            else
            {
