    ...
    public partial class CardLogOn : ApplicationBasePage
    {
        ...
        private void BuildUI()
        {
            ...
            if (Session["CardType"] as string == Constants.CARD_TYPE_SECURE_SWIPE)
            {
                ...
                TableCellFront.CssClass = "";
                TableCellMiddle.Visible = true;
                TableCellLast.CssClass = "";
            }
            else if (Session["CardType"] as string == Constants.CARD_TYPE_SWIPE_AND_GO)
            {
                ...
                TableCellButtonClear.Visible = false;//LinkButtonClear.Visible = false;
                ...
                TableCellFront.CssClass = "Swipe_Go_FrontButton";
                TableCellMiddle.Visible = true;
                TableCellLast.CssClass = "Swipe_Go_LastButton";
            }
            else
            {
        ...
        private void DisplayMessage(ErrorMessageType errorMessageType)
        {
            ...
            TableCellOK.Visible = true;//LinkButtonOk.Visible = true;
        ...
        private void RedirectPage()
        {
            ...
            if (Session["UserSystemID"] != null && Session["DeviceID"] != null)
            {
                ...
                {
                    Response.Redirect("../PSPModel/JobList.aspx?CC=" + userGroup + "", true);
                }
            }
            #endregion
        }
