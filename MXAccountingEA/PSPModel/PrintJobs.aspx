<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintJobs.aspx.cs" Inherits="AccountingPlusEA.PSPModel.PrintJobs" %>
                                                ...
                                                <table width="100%" border="0" cellpadding="0" cellspacing="0" height="38">
                                                    <tr>
                                                        ...
                                                        <td width="35%" align="left" valign="middle" class="Button_Right">
                                                            <asp:Image ID="ImageBack" SkinID="BackButton" runat="server" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </asp:LinkButton>
