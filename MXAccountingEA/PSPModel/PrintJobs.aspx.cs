...
namespace AccountingPlusEA.PSPModel
{
    ...
    public partial class PrintJobs : ApplicationBasePage
    {
        ...
        private void SelectPrintAPI()
        {
            ...
            string targetFrameUri = "../Mfp/FtpPrintJobStatus.aspx";
            ...
            LiteralPrintAPI.Text = string.Format("<iframe src=\"{0}\" frameborder=\"0\" width=\"100%\" height=\"200\" scrolling=\"no\" style=\"overflow: hidden;\"></iframe>", targetFrameUri);
        }
        ...
        private void LocalizeThisPage()
        {
            ...
            LabelPrintingProgress.Text = localizedResources["L_PAGE_IS_LOADING_PLEASE_WAIT"].ToString();
        }
