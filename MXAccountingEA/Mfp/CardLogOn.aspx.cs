...
namespace AccountingPlusEA.Mfp
{
    ...
    /// <remarks>
    /// Class Diagram:<br/>
    /// <img src="ClassDiagrams/CD_PrintReleaseEA.Mfp.CardLogOn.png" />
    /// </remarks>
    /// <remarks>
    public partial class CardLogOn : ApplicationBasePage
    {
        ...
        /// <remarks>
        /// Sequence Diagram:<br/>
        /// 	<img src="SequenceDiagrams/SD_PrintReleaseEA.Mfp.CardLogOn.Page_Load.jpg"/>
        /// </remarks>
        protected void Page_Load(object sender, EventArgs e)
        {
            //#region Save the osaRequest in the Application
            //var osaRequest = new OsaRequestInfo(Page.Request);
            //Dictionary<string, OsaRequestInfo> devMap = null;
            //if (Application["DevMap"] != null)
            //{
            //    Application["DevMap"] = new Dictionary<string, OsaRequestInfo>();

            //}
            //devMap = Application["DevMap"] as Dictionary<string, OsaRequestInfo>;
            //if (devMap.ContainsKey(Request.Params["DeviceId"]))
            //    devMap.Remove(Request.Params["DeviceId"]);
            //devMap.Add(Request.Params["DeviceId"], osaRequest);
            //#endregion
