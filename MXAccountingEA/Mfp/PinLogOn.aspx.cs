...
namespace AccountingPlusEA.Mfp
{
    ...
    /// <remarks>
    /// Class Diagram:<br/>
    /// <img src="ClassDiagrams/CD_PrintReleaseEA.Mfp.PinLogOn.png" />
    /// </remarks>
    /// <remarks>
    public partial class PinLogOn : ApplicationBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                TableReleaseServer.CssClass = "TabsBody_Bg";
                LoginInfo.CssClass = "info_table_Padd";
                LoginUser.CssClass = "MarginPinLoginImg_1";
            }
            else
            {
                TableReleaseServer.CssClass = "TabsBody_Bg_Alter";
                LoginInfo.CssClass = "info_table_Padd_Alter";
                LoginUser.CssClass = "MarginPinLoginImg_1_Alter";
            }
