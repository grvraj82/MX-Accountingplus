...
namespace AccountingPlusEA.Mfp
{
    public partial class Main : System.Web.UI.Page
    {
        ...
        {
            //CallEnableDevice();
            Helper.UserAccount.Remove("101");
            Helper.UserAccount.Create("101", "", "-1", "user", "MFP");
            Helper.DeviceSession.Get(Session["DeviceID"] as string).LogUserInDeviceMode("101", new Helper.MyAccountant(), true, false);
        }

       
        protected void LinkButtonLogin_Click(object sender, EventArgs e)
        {
            Response.Redirect("../Mfp/LogOn.aspx?gac='true'");
        }
