<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobSettings.aspx.cs" Inherits="AccountingPlusEA.Mfp.JobSettings" %>
    ...
    var themeRootURL = "";
        ...
        function CopiesCountDown() {
            ...
            if (!parseInt(tx.value) <= 0) {
                ...
                document.getElementById("HiddenFieldCopiesCount").value=parseInt(tx.value);
            }
            if (tx.value == "" || tx.value == 0) {
                tx.value = 1;
                document.getElementById("HiddenFieldCopiesCount").value=1;
            }
            if (parseInt(tx.value) == 1) {
                makeDisable();
            }
...
<body leftmargin="0" topmargin="0" scroll="NO" class="InsideBG" onload="PageShowingEve(),TrackUserInteraction()">
    ...
    <div style="display: none" id="PageShowingID">
        ...
        <asp:HiddenField ID="HiddenFieldCollateEnabled" runat="server" />
         <asp:HiddenField ID="HiddenFieldCopiesCount"  Value="1" runat="server" />
                                                            ...
                                                            <asp:Table ID="TableMainJobSettings" CellPadding="4" CellSpacing="4" runat="server">
                                                                <asp:TableRow runat="server" ID="TableRowCopies">
                                                                    ...
                                                                    <asp:TableCell HorizontalAlign="Left">
                                                                        <asp:TextBox ID="TextBoxCopies" Width="50" Enabled="false" Text="" MaxLength="3" runat="server" onKeyUp="javascript:onCopiesCountKeyUp()"></asp:TextBox>
