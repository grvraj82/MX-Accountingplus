<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobList.aspx.cs" Inherits="AccountingPlusEA.Mfp.JobList" %>
        ...
        function SelectAllJobs() {
            ...
            try {
                ...
                if (totalRecords == 1) {
                    ...
                    if (objEmailCheckBoxes.length == null || objEmailCheckBoxes.length == undefined) {
                        var jobID = objEmailCheckBoxes.id;
                        jobID = jobID.replace("JobID_", "");
                        objEmailCheckBoxes.checked = true;
                        //                        var rowId = "_row__" + i;
...
<body leftmargin="0" topmargin="0" scroll="NO" onload="LoadPageImages(),PageShowingEve(),TrackUserInteraction(),init()"
    class="InsideBG">
    <div runat="server" style="display: inline; width: 500px; left: 30px; z-index: 1;
        position: absolute" id="PageLoadingID">
    ...
    <div runat="server" style="display: none; z-index: 1; position: absolute" id="DivJoblistredirect">
        <table cellpadding="0" cellspacing="0" border="0" width="100%" height="350">
            <tr style="margin-left: 200px">
                <td align="right" width="40%" valign="middle">
                    <asp:Image ID="ImageLoading" runat="server" />
                </td>
                <td align="left" width="17%" valign="middle" class="Login_TextFonts">
                    <asp:Label ID="LabelLoading" runat="server" Text=""></asp:Label>
                </td>
                <td width="43%">
                </td>
            </tr>
    ...
    <div style="display: none" id="PageShowingID" runat="server">
            ...
            <tr>
                <td height="50" align="left" valign="top">
                    ...
                    <asp:Table Width="100%" BorderWidth="0" CellPadding="0" CellSpacing="0" Height="50"
                        ...
                        <asp:TableRow>
                            <asp:TableCell Width="38%" CssClass="Inside_TOPTitleFontBold">
                            ...
                            <asp:TableCell Width="12%" ID="TableCellLimits" runat="server">
                                <div id="Div1" style="display: inline">
                                    <asp:LinkButton ID="LinkButtonLimits" OnClick="ImageButtonLimits_Click" runat="server">
                                        <table width="82%" border="0" cellpadding="0" cellspacing="0" height="38">
                                            <tr>
                                                ...
                                                <td width="75%" align="center" valign="middle" class="Button_center">
                                                    <div class="Login_TextFonts">
                                                        <asp:Label ID="LabelLimits" runat="server" Text="Limits"></asp:Label>
                                                    </div>
                                                </td>
                            ...
                            <asp:TableCell Width="12%" ID="TableCellBalance" runat="server">
                                <div id="DivBalance" style="display: inline">
                                    <asp:LinkButton ID="LinkButtonBalance" runat="server" OnClick="ImageButtonBalance_Click">
                                        <table width="82%" border="0" cellpadding="0" cellspacing="0" height="38">
                                            <tr>
                                                <td width="4%" align="left" valign="middle" class="Button_Left">
                                                </td>
                                                <td width="75%" align="center" valign="middle" class="Button_center">
                                                    <div class="Login_TextFonts">
                                                        <asp:Label ID="LabelBalance" runat="server" Text="Home"></asp:Label>
                                                    </div>
                                                </td>
                                                <td width="3%" align="left" valign="middle" class="Button_Right">
                                                </td>
                            ...
                            <asp:TableCell Width="14%" ID="TableCellDevicemode" runat="server">
                                <div id="PanelDeviceMode" style="display: inline">
                                    <asp:LinkButton ID="LinkButtonDeviceMode" OnClick="LinkButtonDeviceMode_Click" runat="server" >
                                        <table width="82%" border="0" cellpadding="0" cellspacing="0" height="38">
                                            <tr>
                                                <td width="2%" align="left" valign="top" class="Button_Left">
                                                </td>
                                                <td width="75%" align="center" valign="middle" class="Button_center">
                                                    <div runat="server" id="divMFPMode" class="Login_TextFonts" style="white-space:nowrap;">
                            ...
                            <asp:TableCell Visible="true" Width="12%" ID="TableCellLogOff">
                                <div id="DivLogOff" style="display: inline">
                                    <asp:LinkButton ID="LinkButtonLogOff" Visible="true" OnClick="LinkButtonLogOff_Click"
                                        runat="server">
                                        <table width="82%" border="0" cellpadding="0" cellspacing="0" height="38">
                                            <tr>
                                                <td width="4%" align="left" valign="middle" class="Button_Left">
                ...
                <td height="40" align="left" valign="bottom">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" height="50">
                        <tr>
                            ...
                            <td width="2%">
                                <asp:Label ID="LabelCard" runat="server" Text="Label" Font-Size="8" ></asp:Label>
                            </td>
