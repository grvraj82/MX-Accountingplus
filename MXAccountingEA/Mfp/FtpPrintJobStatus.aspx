<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FtpPrintJobStatus.aspx.cs"
    Inherits="AccountingPlusEA.Mfp.FtpPrintJobStatus" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function RedirectTo() {
            ...
            parent.location.href = "../SKY/JobList.aspx?ID=Status";
            if (isPSPModel == "True") {
                                ...
                                <tr class="Error_msgcenter">
                                    <td align="center" style="width: 100%;">
                                        <asp:Label ID="LabelPSPCommunicator" Font-Names="Verdana,Arial" Font-Bold="true"
                                            ForeColor="Red" runat="server" Text="Print jobs submitted Successfully"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" width="100%">
