...
namespace AccountingPlusDevice.PSPModel
{
    ...
    public partial class JobSettings : ApplicationBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    DropDownListOutPutTray.CssClass = "Settings_Font_DropDown";
        ...
        private void ApplyThemes()
        {
            ...
            ImageButtonCancel.ImageUrl = string.Format("../App_Themes/{0}/{1}/Images/Cance_print.png", currentTheme, deviceModel);
            ImageButtonPrint.ImageUrl = string.Format("../App_Themes/{0}/{1}/Images/Print_IMG.png", currentTheme, deviceModel);
            ImageCopiesUp.ImageUrl = string.Format("../App_Themes/{0}/{1}/Images/Number_Up.png", currentTheme, deviceModel);
            ImageCopiesDown.ImageUrl = string.Format("../App_Themes/{0}/{1}/Images/Number_down.png", currentTheme, deviceModel);
        ...
        private void IsDuplexSupprotEnabled()
        {
            ...
            if (duplexSupportStatus == "Enable")
            {
                ...
                TableRowDuplexMode.Enabled = true;
