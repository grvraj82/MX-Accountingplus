<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectCostCenter.aspx.cs"
    Inherits="AccountingPlusDevice.PSPModel.SelectCostCenter" %>
            ...
            <tr>
                <td height="50" align="left" valign="top">
                    ...
                    <asp:Table ID="Table1" Width="100%" BorderWidth="0" CellPadding="0" CellSpacing="0"
                        ...
                        <asp:TableRow>
                            <asp:TableCell Width="82%" CssClass="Inside_TOPTitleFontBold">
                            ...
                            <td width="90%" align="center" valign="top">
                                <asp:Table ID="TableCostCenterList" runat="server" Height="42" border="0" CellPadding="0"
                                    ...
                                    <asp:TableHeaderRow CssClass="Title_bar_bg" Height="30">
                                        ...
                                        <asp:TableCell ID="TableCell7" Width="13" runat="server" class="Vr_Line_Insidepage"
                                            RowSpan="1000">
                                        </asp:TableCell>
                                        <asp:TableHeaderCell ID="HeaderCellCostCenterName" Wrap="false" Text="Cost Center Name"
                                            Width="60%" Style="font-size: small">
                                        </asp:TableHeaderCell>
                                        <asp:TableCell ID="TableCell1" Width="13" runat="server" class="Vr_Line_Insidepage"
                                            RowSpan="1000">
                                        </asp:TableCell>
                                        <asp:TableHeaderCell ID="TableHeaderCellAccess" Wrap="false" Text="Access ?" Width="60%"
                                            Style="font-size: small">
                                        </asp:TableHeaderCell>
                                        <asp:TableCell ID="TableCell3" Width="13" runat="server" class="Vr_Line_Insidepage"
                                            RowSpan="1000">
                                        </asp:TableCell>
                                        <asp:TableHeaderCell ID="TableHeaderCellPermissions" Wrap="false" Text="Permissions & Limits"
                                            Width="40%" Style="font-size: small">
                                        </asp:TableHeaderCell>
