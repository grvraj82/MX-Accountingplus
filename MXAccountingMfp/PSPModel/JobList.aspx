<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobList.aspx.cs" Inherits="AccountingPlusDevice.PSPModel.JobList" %>
...
<body leftmargin="0" topmargin="0" scroll="NO" onload="LoadPageImages(),PageShowingEve(),TrackUserInteraction()"
    ...
    <div style="display: none" id="PageShowingID">
        ...
        <table width="440" border="0" cellpadding="0" cellspacing="0" height="255">
            <tr>
                <td>
                    <asp:Table CellPadding="0" CellSpacing="0" BorderWidth="0" Width="100%" Height="36"
                        runat="server">
                        <asp:TableRow>
                            <asp:TableCell Width="30%" CssClass="Inside_TOPTitleFontBold" HorizontalAlign="left"
                                VerticalAlign="middle">
                                <asp:Label ID="LabelJobListPageTitle" runat="server" Text=""></asp:Label>
                            </asp:TableCell>
                            <asp:TableCell Width="40%" CssClass="Inside_TOPTitleUserFontBold" HorizontalAlign="left"
                                VerticalAlign="middle">
                            ...
                            <asp:TableCell ID="TableCellLogOff" Width="10%" HorizontalAlign="center" VerticalAlign="top">
