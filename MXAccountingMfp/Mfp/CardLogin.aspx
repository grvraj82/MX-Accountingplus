<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/LogOn.Master" AutoEventWireup="true"
    CodeBehind="CardLogin.aspx.cs" Inherits="AccountingPlusDevice.Mfp.CardLogin" %>
                    ...
                    <asp:Table runat="server" ID="TableLogOn" Width="95%" CellPadding="3" CellSpacing="3"
                                ...
                                <table width="80%" border="0" cellpadding="0" cellspacing="0" class="info_table"
                                    ...
                                    <tr>
                                        ...
                                        <td width="94%" align="left" valign="middle">
                                            <asp:Label ID="LabelCardLogOnMessage" Visible="false" runat="server" Text=""></asp:Label>
                                            <asp:Label ID="LabelCardSwipe" Visible="false" runat="server" Text="You will be redirected to card login in 5 seconds ..."></asp:Label>
                            ...
                            <asp:TableCell Height="130" HorizontalAlign="left" VerticalAlign="Middle">
                                <asp:Table ID="Table1" Width="90%" CellPadding="0" CellSpacing="0" runat="server">
                                    <asp:TableRow>
                                        ...
                                        <asp:TableCell Width="80%" HorizontalAlign="Left" VerticalAlign="Middle">
                        ...
                        <asp:TableRow ID="TableLogOnButtons">
                            <asp:TableCell Height="20" HorizontalAlign="Center" VerticalAlign="top">
                                <asp:Table ID="Table3" Width="90%" runat="server" CellPadding="0" CellSpacing="0"
                                    border="0">
                                    <asp:TableRow>
                                        ...
                                        <asp:TableCell Width="30%" HorizontalAlign="Right" VerticalAlign="middle">
                                            <asp:LinkButton ID="LinkButtonManualLogOn" OnClick="LinkButtonManualLogOn_Click"
                                                ...
                                                <a href="javascript:RedirectToManualLogin()">
                                                    <asp:Table ID="Table4" Width="82%" CellPadding="0" CellSpacing="0" Height="38" runat="server"
                                                        border="0">
                                                        <asp:TableRow>
